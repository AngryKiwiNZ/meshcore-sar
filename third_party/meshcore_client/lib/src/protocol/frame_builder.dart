...
class FrameBuilder {
  ...
  /// [bandwidth] is the radio bandwidth in Hz.
  ...
  static Uint8List buildSetRadioParams({
    ...
    writer.writeUInt32LE(bandwidth);
  ...
  static Uint8List buildSendTracePath({
    ...
    final keyLen = (prefixToHop.containsKey(prefixSize) ? prefixSize : 1).clamp(
      1,
      contactPublicKey.length,
    );
    final writer = BufferWriter();
